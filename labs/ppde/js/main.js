...
function drawSome(paper) {
  ...
  //var img = paper.image("../img/szmhaz.png", 0, 0, 960, 720);
  ...
  var also_e6 = "m 143.98387,514.04839 297.44516,44.83548 0,-124.66452 L 143.98387,414.9";
  ...
  //var also_e7 = "m 573.38387,607 134.87097,-52.85484 90.45817,-23.37771 -0.11935,-34.30187 -84.98398,22.80538 0.47742,-101.45483 84.57419,-9.37742";
  var also_e7 = "m 573.38387,607 134.87097,-52.85484 90.45817,-23.37771 -0.11935,-34.30187 -84.57839,23.41377 0.0718,-102.06322 84.57419,-9.37742";
  var also_e8 = "m 609.40559,535.04895 0,-94.3007";
  ...
  var teto_also_e1 = "M 91.045161,294.03871 534.19355,274.99355 839.84516,297.29032";
  ...
  drawPath(
    ...
    kuszob,
    wire_speed,
    { fill: fill_color, stroke: wire_color, 'fill-opacity': fill_opa },
    function() {
      drawPath(
        paper,
        kuszob_e1,
      ...
      drawPath(
        ...
        { fill: fill_color, stroke: wire_color, 'fill-opacity': fill_opa },
        function() {
          drawPath( paper, also_e1, wire_speed, { fill: fill_color, stroke: wire_color, 'fill-opacity': fill_opa }, function() { } );
          drawPath( paper, also_e2, wire_speed, { fill: fill_color, stroke: wire_color, 'fill-opacity': fill_opa }, function() { } );
          drawPath( paper, also_e3, wire_speed, { fill: fill_color, stroke: wire_color, 'fill-opacity': fill_opa },
            function() {
              drawPath( paper, also_e4, wire_speed, { fill: fill_color, stroke: wire_color, 'fill-opacity': fill_opa }, function() { } );
              drawPath( paper, also_e5, wire_speed, { fill: fill_color, stroke: wire_color, 'fill-opacity': fill_opa }, function() { } );
              drawPath( paper, also_e6, wire_speed, { fill: fill_color, stroke: wire_color, 'fill-opacity': fill_opa },
                function() {
                  drawPath( paper, also_e7, wire_speed, { fill: fill_color, stroke: wire_color, 'fill-opacity': fill_opa }, function() { } );
                  drawPath( paper, also_e8, wire_speed, { fill: fill_color, stroke: wire_color, 'fill-opacity': fill_opa }, function() { } );
                } );
            }
          );
          drawPath(
          ...
          drawPath(
            ...
            { fill: fill_color, stroke: wire_color, 'fill-opacity': fill_opa },
            function() {
              drawPath( paper, teto_also_e1, wire_speed, { fill: fill_color, stroke: wire_color, 'fill-opacity': fill_opa }, function() { } );
              drawPath(
                paper,
                teto_also,
                wire_speed,
...
function drawPath( canvas, pathstr, duration, attr, callback )
{
  var guide_path = canvas.path( pathstr ).attr(
    { stroke: wire_color, 'stroke-opacity': 0, fill: fill_color, 'fill-opacity': fill_opa }
  );
  var path = canvas.path( guide_path.getSubpath( 0, 0.999 ) ).attr( attr );
